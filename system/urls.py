...
urlpatterns = [
    ...
    path('club/<str:club_name>/ban/<int:user_id>/', views.ban_member,name='ban_member'),
    path('club/<str:club_name>/unban/<int:user_id>/', views.unban_member,name='unban_member'),
    path('club/<str:club_name>/banned_list/', views.banned_members_list,name='banned_list'),
    path('club/<str:club_name>/applicants/',views.applicants_list,name='applicants_list'),
